...
object DotaBuffCall {
  ...
  val userIDs = List("112427189", "116894024", "92253911", "224417226", "120301254", "165818364", "133208812", "42344936", "141246748",
  ...
  def main(args: Array[String]): Unit = {
    setupProxy
    val allMatches = userIDs.map(getAllMatches)
  ...
  // if you need proxy for getting connection
