...
object Q {
  ...
  def main(args: Array[String]): Unit = {
    br = new BufferedReader(new InputStreamReader(new FileInputStream("/home/kperikov/projects/sport-dangerzone/src/main/java/org/mystic/ipsc/ipsc2017/r1.in")))
    out = new PrintWriter(new BufferedOutputStream(new FileOutputStream("r1.out")))
    solve
    out.close
  }
