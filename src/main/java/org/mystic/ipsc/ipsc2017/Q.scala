...
object Q {
  ...
  def main(args: Array[String]): Unit = {
    br = new BufferedReader(new InputStreamReader(new FileInputStream("/home/kperikov/projects/sport-dangerzone/src/main/java/org/mystic/ipsc/ipsc2017/q2.in")))
    out = new PrintWriter(new BufferedOutputStream(new FileOutputStream("q2.out")))
    solve
    out.close
  }
  ...
  def solve = {
    ...
    for (_ <- 0 until t) {
      ...
      val sort = arr.sortBy(-_._2)
      out.println(sort(0)._1)
    }
